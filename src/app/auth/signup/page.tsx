    ...
    if (authData.user) {
      await supabase.from('consent_log').insert([
        ...
        },
        {
          ...
          consented: data.marketingConsent ?? false,
        },
      ])
    }
            ...
            <div className="space-y-3 pt-1">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-400">
                  I accept the{' '}
                  <Link href="/terms" target="_blank" className="text-saffron-600 hover:underline">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" target="_blank" className="text-saffron-600 hover:underline">
                    Privacy Policy
                  </Link>
              ...
              {errors.acceptTerms && (
                <p className="text-xs text-rose-600 ml-7">{errors.acceptTerms.message}</p>
              )}
